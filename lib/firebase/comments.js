...
// Delete all comments for a specific user
export const deleteUserComments = async (userId) => {
  try {
    ...
    await batch.commit();
    console.log(`Deleted ${deletedCount} comments for user ID: ${userId}`);
    return { success: true, deletedCount };
  } catch (error) {
    console.error(`Error deleting comments for user ID: ${userId}`, error);
    return { success: false, error: error.message };
  }
}; 